...
<head>
  ...
  <style>
    ...
    /* Make property images responsive */
            ...
            while ($property_result = mysqli_fetch_assoc($result)) {
              ...
              <div class="col-lg-4 col-sm-6">
                <div class="properties">
                  <div class="image-holder"><img src="<?php echo $property_img ? '../images/properties/' . $property_img : '../images/properties/default1.png'; ?>" class="img-responsive"
                      alt="properties">
                  </div>
